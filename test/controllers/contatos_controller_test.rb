...
class ContatosControllerTest < ActionController::TestCase
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post :create, contato: { email: @contato.email, endereco: @contato.endereco, nome: @contato.nome, observacao: @contato.observacao, telefone: @contato.telefone }
    end
  ...
  test "should update contato" do
    patch :update, id: @contato, contato: { email: @contato.email, endereco: @contato.endereco, nome: @contato.nome, observacao: @contato.observacao, telefone: @contato.telefone }
    assert_redirected_to contato_path(assigns(:contato))
  end
